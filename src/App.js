...
const DEF_FRAIS=[
  ...
  {id:7,label:"Carburant manquant",montant:50},
  {id:8,label:"Nettoyage intérieur",montant:80},{id:9,label:"Nettoyage extérieur",montant:50},
  {id:10,label:"Forfait tabac",montant:80},
  {id:11,label:"Frais gestion amende",montant:40},
...
function buildContratHTML(contrat,vehicle,sigL,sigLoc,profil){
  ...
  const CG_ARTICLES=[
    ...
    {n:2,t:"Conditions d'acces et controle d'identite",x:"Le locataire et tout conducteur autorise doivent : avoir l'age minimum exige, etre titulaires d'un permis de conduire valide correspondant a la categorie du vehicule, presenter une piece d'identite valide et fournir des informations exactes et completes. Seul le locataire designe est autorise a conduire. Toute conduite par un tiers non expressement autorise par ecrit est strictement interdite. Toute declaration inexacte ou document falsifie entraine la nullite totale des garanties d'assurance et engage la responsabilite financiere integrale du locataire."},
